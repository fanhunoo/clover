...
<head>
    ...
    <link rel="stylesheet" href="${(request.contextPath)!}/css/index.css" media="all" />
</head>
<style>
    .mag0{ margin:0 !important; }
    .userName{color: #93D1FF}
</style>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo">紫苜蓿管理系统</a>
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="seraph hideMenu icon-caidan"></a>
            <!-- 顶级菜单 -->
            <ul class="layui-nav mobileTopLevelMenus" mobile>
                <li class="layui-nav-item" data-menu="contentManagement">
                    <a href="javascript:;"><i class="seraph icon-caidan"></i><cite>紫苜蓿管理系统</cite></a>
                    <dl class="layui-nav-child">
                    <#list topMenus as topMenu>
                        <dd data-menu="${topMenu.id!}">
                            <a href="javascript:;"><i class="layui-icon" data-icon="${topMenu.icon!}">${topMenu.icon!}</i><cite>${topMenu.name!}</cite></a>
                        </dd>
                    </#list>
                    </dl>
                </li>
            ...
            <ul class="layui-nav topLevelMenus" pc>
                <#list topMenus as topMenu>
                    <li class="layui-nav-item" data-menu="${topMenu.id!}">
                        <a href="javascript:;"><i class="layui-icon" data-icon="${topMenu.icon!}">${topMenu.icon!}</i><cite>${topMenu.name!}</cite></a>
                    </li>
                </#list>
            </ul>
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${(request.contextPath)!}/statics/icon/clover.png" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${realname!}</cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${(request.contextPath)!}/logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${(request.contextPath)!}/statics/icon/clover.png" class="userAvatar"></a>
            <p>你好！<span class="userName">${realname!}</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2018 fanhunoo</span>　　
